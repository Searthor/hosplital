...
class DetialsComponent extends Component
{
    ...
    public $medicine_id, $med_id, $medicine_to_user, $appointment_detail, $time_list = [],$check_time=[],$old_time;
    public function mount($id)
    {
        ...
        if ($data->appointments == 'Yes') {
            ...
            $this->old_time = $appointment->time;
    ...
    public function render()
    {
        ...
        if ($this->appointment_date) {
            $this->check_time = Appointment::where('d_id', $this->doctor_appointment_id)->where('date', $this->appointment_date)->get();
        }
