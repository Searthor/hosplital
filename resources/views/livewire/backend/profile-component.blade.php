                                ...
                                <div class="active tab-pane" id="settings">
                                    <form class="form-horizontal">
                                        <div class="form-group row">
                                            <label for="inputName" class="col-sm-4 col-form-label">{{ __('lang.firstname') }} </label>
                                            <div class="col-md-12">
                                                <input type="text" wire:model="firstname" class="form-control" id="inputName" placeholder="{{ __('lang.firstname') }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputName" class="col-sm-4 col-form-label">{{ __('lang.lastname') }} </label>
                                            <div class="col-md-12">
                                                <input type="text" wire:model="lastname" class="form-control" id="inputName" placeholder="{{ __('lang.lastname') }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputName" class="col-sm-4 col-form-label">{{ __('lang.email') }} </label>
                                            <div class="col-md-12">
                                                <input type="email" wire:model="email" class="form-control" id="inputName" placeholder="{{ __('lang.email') }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputName2" class="col-sm-4 col-form-label">{{ __('lang.province') }} </label>
                                            <div class="col-md-12">
                                        ...
                                        <div class="form-group row">
                                            <label for="inputName2" class="col-sm-4 col-form-label">{{ __('lang.district') }} </label>
                                            <div class="col-md-12">
                                        ...
                                        <div class="form-group row">
                                            <label for="inputName2" class="col-sm-4 col-form-label">{{ __('lang.village') }} </label>
                                            <div class="col-md-12">
                                        ...
                                        <div class="form-group row">
                                            <label for="inputName2" class="col-sm-4 col-form-label">{{ __('lang.password') }} </label>
                                            <div class="col-md-12">
                                                <input type="password" wire:model="password" class="form-control @error('password') is-invalid @enderror" id="inputName2" placeholder="ປ້ອນຂໍ້ມູນ">
                                                @error('password')
                                        ...
                                        <div class="form-group row">
                                            <label for="inputName2" class="col-sm-12 col-form-label">{{ __('lang.confirm_password') }} </label>
                                            <div class="col-md-12">
                                                <input type="password" wire:model="confirmpassword" class="form-control @error('confirmpassword') is-invalid @enderror" id="inputName2" placeholder="ປ້ອນຂໍ້ມູນ">
                                        ...
                                        <div class="form-group row">
                                            <div class="offset-sm-4 col-md-12">
                                                <button type="button" wire:click="updateProfile" class="btn btn-dark"><i class="fas fa-edit"></i>
