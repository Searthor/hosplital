                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">ຢາ</li>
                        </ol>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group" wire:ignore>
                                                <label>ປະເພດຢາ<span class="text-danger">*</span></label>
                                                <select wire:model='type' id="select-medicines-type"
                                                    class="form-control">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>ຊື່ຢາ<span class="text-danger">*</span> </label>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            $('#select-medicines-type').select2();
            $('#select-medicines-type').on('change', function(e) {
                var data = $('#select-medicines-type').select2("val");
                @this.set('type', data);
            });
        });
